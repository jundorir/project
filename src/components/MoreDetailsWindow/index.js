      ...
      >
        ...
        <div className={css.center}>
          <div className={css.title}>
            {language.title}
            {currentNper.toString().padStart(3, 0)}
            {language.period}
          </div>
          <div className={css.line}></div>
          <div className={css.info}>
            <div className={css.total}>
              <div className={css.top}>{language.total}</div>
              <div className={css.bottom}>{getTotalSales}T</div>
            </div>
            <div className={css.division}></div>
            <div className={css.price}>
              <div className={css.top}>{language.price}</div>
              <div className={css.bottom}>{TPrice}WFIL/T</div>
            </div>
          </div>
          <div className={css.line}></div>
