...
function AddMobility(props) {
  ...
  const USDT_isApprove = AFIL_APPROVE_AMOUNT >= AFILSwapNumber;
  const MMR_isApprove = WFIL_APPROVE_AMOUNT >= WFILSwapNumber;
  const isApprove = USDT_isApprove && MMR_isApprove;
  const isAvailable =
  ...
  async function queryBalanceAll() {
    const AFIL = await chain.queryBalance("USDT");
    const WFIL = await chain.queryBalance("MMR");
    ...
    if (showModal === "approve")
      return (
        <AuthorizationModal
          ...
          USDT_isApprove={USDT_isApprove}
          MMR_isApprove={MMR_isApprove}
        />
      );
    if (showModal === "supply")
      return (
      ...
      <div className={css.box}>
        ...
        <div className={classNames(css.exchangeBox, change && css.afterChange)}>
          <div className={css.from}>
            ...
            <div className={css.bottom}>
              <div className={css.left}>USDT{language.balance}</div>
          ...
          <div className={css.to}>
            ...
            <div className={css.bottom}>
              <div className={css.left}>MMR{language.balance}</div>
        ...
        <div className={css.portionBox}>
          ...
          <div className={css.middle}>
            1USDT ≈ {mobility.BTOA} MMR
            {/* <div className={css.left}>
              <div>{mobility.ATOB}</div>
              <div className={css.symbol}>USDT/MMR</div>
            </div>
            <div className={css.right}>
              <div>{mobility.BTOA}</div>
              <div className={css.symbol}>MMR/USDT</div>
            </div> */}
          </div>
          <div className={css.bottom}>
